...
| <a name="input_secret_environment_variables"></a> [secret\_environment\_variables](#input\_secret\_environment\_variables) | The secrets to pass to the container, as name => source. A value starting with arn: is used as a Secrets Manager ARN; anything else is an SSM parameter path under parameter\_path\_prefix. For more information, see [Specifying Sensitive Data](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data.html) in the Amazon Elastic Container Service Developer Guide | `map(string)` | `{}` | no |
