...
| <a name="input_ssm_environment_variables"></a> [ssm\_environment\_variables](#input\_ssm\_environment\_variables) | SSM Parameter Store secrets to pass to the container, as name => parameter path under parameter\_path\_prefix. For more information, see [Specifying Sensitive Data](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data.html) in the Amazon Elastic Container Service Developer Guide | `map(string)` | `{}` | no |
